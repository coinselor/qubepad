...
const PillarIcon = forwardRef<SVGSVGElement, React.ComponentPropsWithoutRef<'svg'>>(({ className, ...props }, ref) => {
	return (
		...
		>
			...
			<path d="M14.5383 13.6202L16.7654 14.8958L8.73538 19.538L0.71582 14.9062L2.97427 13.5994" stroke="#12FF3C" strokeWidth="0.75" strokeLinecap="round" strokeLinejoin="round" />
		</svg>
	)
})
