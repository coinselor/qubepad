...
export const VALIDATION_MESSAGES = {
    ...
    PILLAR_NAME_PATTERN: "Pillar name can only contain letters, numbers, and single instances of hyphen, dot, or underscore between characters",
    PUBLIC_KEY_LENGTH: "Public key must be exactly 64 hexadecimal characters (32 bytes)",
    ...
    SIGNATURE_LENGTH: "Signature must be exactly 128 hexadecimal characters (64 bytes)",
...
export const pillarFormSchema = z.object({
    ...
    hqzName: z.string()
        ...
        .max(PILLAR_NAME_MAX_LENGTH, { message: VALIDATION_MESSAGES.PILLAR_NAME_MAX_LENGTH })
        .refine((val) => PILLAR_NAME_REGEX.test(val), {
            message: VALIDATION_MESSAGES.PILLAR_NAME_PATTERN
        }),
    hqzOwnerAddress: z.string()
